...
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000028', 'anda roti wrap', array['breakfast', 'dinner']::text[], 15, 2, 15, 390, '[{"ingredient_id":"00000001-0000-4000-8000-000000000012","qty_hint":"2"},{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1 small"},{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"for 2 rotis"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"2 tsp"}]'::jsonb, '["Make two rotis, or warm yesterday’s.","Scramble the eggs with onion, salt and chilli.","Roll the bhurji inside the rotis and pan-press for a minute."]'::jsonb, array['budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000029', 'atta halwa with chai', array['breakfast']::text[], 15, 2, 7, 380, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"0.5 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"2 tbsp"},{"ingredient_id":"00000001-0000-4000-8000-000000000008","qty_hint":"2 tbsp"},{"ingredient_id":"00000001-0000-4000-8000-000000000010","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000009","qty_hint":"for 1 cup"}]'::jsonb, '["Roast the atta in ghee until it smells nutty and turns golden.","Add warm milk and sugar, stirring until it thickens.","Brew your chai alongside and sit down with both."]'::jsonb, array['budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000030', 'seasonal fruit and curd bowl', array['any', 'breakfast']::text[], 5, 1, 8, 260, '[{"ingredient_id":"00000001-0000-4000-8000-000000000011","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000060","qty_hint":"1 cup chopped"},{"ingredient_id":"00000001-0000-4000-8000-000000000057","qty_hint":"1"}]'::jsonb, '["Chop whatever fruit is in the kitchen.","Fold into whisked curd with a little sugar or jaggery."]'::jsonb, array['no-cook', 'vrat-safe']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000031', 'peanut butter banana sandwich', array['any', 'breakfast']::text[], 5, 1, 11, 340, '[{"ingredient_id":"00000001-0000-4000-8000-000000000055","qty_hint":"2 slices"},{"ingredient_id":"00000001-0000-4000-8000-000000000072","qty_hint":"2 tbsp"},{"ingredient_id":"00000001-0000-4000-8000-000000000057","qty_hint":"1"}]'::jsonb, '["Spread the peanut butter generously.","Layer banana slices, close, and halve."]'::jsonb, array['no-cook']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000032', 'kachumber chaat bowl', array['any']::text[], 8, 1, 4, 150, '[{"ingredient_id":"00000001-0000-4000-8000-000000000029","qty_hint":"1"},{"ingredient_id":"00000001-0000-4000-8000-000000000013","qty_hint":"1"},{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1 small"},{"ingredient_id":"00000001-0000-4000-8000-000000000034","qty_hint":"half"}]'::jsonb, '["Dice cucumber, tomato and onion evenly.","Toss with salt, chaat masala and lemon juice."]'::jsonb, array['no-cook', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000033', 'dahi chiwda', array['any', 'breakfast']::text[], 5, 1, 7, 280, '[{"ingredient_id":"00000001-0000-4000-8000-000000000051","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000011","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000008","qty_hint":"1 tsp"}]'::jsonb, '["Rinse the poha and let it soften for two minutes.","Stir into curd with sugar or jaggery and a pinch of salt."]'::jsonb, array['no-cook', 'budget', 'vrat-safe']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000034', 'dal paratha', array['breakfast', 'lunch']::text[], 15, 2, 11, 380, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Knead the leftover dal straight into atta — no extra water.","Rest the dough five minutes.","Roll out parathas and roast with oil until golden.","Serve with curd or pickle."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000035', 'dal tadka rice bowl', array['lunch', 'dinner']::text[], 12, 2, 16, 460, '[{"ingredient_id":"00000001-0000-4000-8000-000000000002","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"1 tbsp"}]'::jsonb, '["Warm the leftover dal with a splash of water.","Make a fresh tadka of ghee, jeera and chilli; pour it over.","Serve on hot rice."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000036', 'dal cheela', array['breakfast']::text[], 15, 2, 13, 320, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"0.5 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Whisk the leftover dal with atta into a pourable batter.","Season with salt, chilli and coriander.","Spread on a hot tawa and cook both sides with a little oil."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000037', 'dal shorba', array['dinner', 'any']::text[], 10, 1, 9, 180, '[{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"2 tsp"}]'::jsonb, '["Thin the leftover dal with hot water to soup consistency.","Temper jeera and garlic in ghee; pour over.","Simmer three minutes and finish with lemon."]'::jsonb, array['leftover-transform', 'recovery', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000038', 'dal khichdi refresh', array['dinner']::text[], 15, 2, 14, 420, '[{"ingredient_id":"00000001-0000-4000-8000-000000000002","qty_hint":"0.5 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"1 tbsp"}]'::jsonb, '["Simmer the leftover dal with rinsed rice and two cups of water.","Season with turmeric and salt.","Cook covered until the rice is soft, then finish with ghee."]'::jsonb, array['leftover-transform', 'recovery', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000039', 'sabzi paratha', array['breakfast', 'lunch']::text[], 15, 2, 9, 390, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Mash the leftover sabzi well.","Knead it into atta — the sabzi replaces the water.","Roll and roast parathas with oil until crisp-edged.","Serve with curd."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
...
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000041', 'sabzi pulao', array['lunch', 'dinner']::text[], 15, 2, 8, 430, '[{"ingredient_id":"00000001-0000-4000-8000-000000000002","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Heat oil, crackle jeera, and add the leftover sabzi.","Fold in cooked rice and toss on high heat.","Adjust salt and finish with coriander."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000042', 'sabzi egg scramble', array['breakfast', 'dinner']::text[], 10, 2, 15, 330, '[{"ingredient_id":"00000001-0000-4000-8000-000000000012","qty_hint":"2"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"2 tsp"}]'::jsonb, '["Heat the leftover sabzi in a little oil, breaking it down.","Crack in the eggs and scramble until just set.","Season and serve with toast or roti."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000043', 'crispy sabzi chaat', array['any']::text[], 12, 2, 6, 280, '[{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1 small"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Pan-crisp the leftover sabzi in oil until the edges brown.","Top with chopped onion, chaat masala and lemon.","Add curd on top if you have it."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000044', 'jeera ghee rice', array['lunch', 'dinner']::text[], 8, 1, 6, 380, '[{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"1 tbsp"}]'::jsonb, '["Heat ghee and crackle jeera generously.","Add the leftover rice and toss until glossy and hot.","Season with salt; serve with curd or dal."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000045', 'desi egg fried rice', array['lunch', 'dinner']::text[], 15, 2, 17, 480, '[{"ingredient_id":"00000001-0000-4000-8000-000000000012","qty_hint":"2"},{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Scramble the eggs in hot oil and set aside.","Sauté onion and any vegetables on high heat.","Add the leftover rice, eggs, salt and pepper; toss hard.","Finish with a dash of lemon."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000046', 'quick rice kheer', array['any']::text[], 15, 2, 8, 320, '[{"ingredient_id":"00000001-0000-4000-8000-000000000010","qty_hint":"2 cups"},{"ingredient_id":"00000001-0000-4000-8000-000000000008","qty_hint":"2 tbsp"}]'::jsonb, '["Simmer the leftover rice in milk, mashing as it thickens.","Sweeten with sugar and a pinch of cardamom.","Serve warm or chilled."]'::jsonb, array['leftover-transform', 'vrat-safe']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000047', 'comfort dal-rice bowl', array['dinner']::text[], 12, 1, 13, 430, '[{"ingredient_id":"00000001-0000-4000-8000-000000000003","qty_hint":"1 cup cooked"},{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"1 tbsp"}]'::jsonb, '["Warm the leftover rice and dal together with a splash of water.","Top with ghee and a pinch of salt.","Eat from the bowl — comfort first."]'::jsonb, array['leftover-transform', 'recovery', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000048', 'ghee-sugar churma roti', array['any']::text[], 8, 1, 5, 340, '[{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"1 tbsp"},{"ingredient_id":"00000001-0000-4000-8000-000000000008","qty_hint":"1 tbsp"}]'::jsonb, '["Crisp the leftover rotis on a tawa.","Crush into pieces while warm.","Toss with melted ghee and sugar or jaggery."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000049', 'kothu roti with egg', array['dinner']::text[], 15, 2, 14, 420, '[{"ingredient_id":"00000001-0000-4000-8000-000000000012","qty_hint":"2"},{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Shred the leftover rotis into ribbons.","Sauté onion, then scramble in the eggs.","Add the roti ribbons and toss on high heat with the masalas."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000050', 'roti upma', array['breakfast']::text[], 12, 2, 7, 330, '[{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Tear the leftover rotis into small pieces.","Temper mustard seeds and onion in oil.","Toss in the roti with turmeric, salt and a splash of water.","Cover for two minutes so it softens."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000051', 'warm milk-roti bowl', array['any']::text[], 5, 1, 9, 310, '[{"ingredient_id":"00000001-0000-4000-8000-000000000010","qty_hint":"1.5 cups"},{"ingredient_id":"00000001-0000-4000-8000-000000000008","qty_hint":"1 tbsp"}]'::jsonb, '["Warm the milk with sugar.","Crumble in the leftover roti and let it soak for two minutes."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000052', 'dal-stuffed roti tacos', array['lunch', 'dinner']::text[], 12, 2, 12, 390, '[{"ingredient_id":"00000001-0000-4000-8000-000000000003","qty_hint":"1 cup cooked"},{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1 small"}]'::jsonb, '["Thicken the leftover dal in a pan until scoopable.","Warm the rotis and fold like tacos.","Fill with dal, chopped onion and a hit of chaat masala."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000053', 'curry rice bowl', array['lunch', 'dinner']::text[], 10, 1, 14, 450, '[{"ingredient_id":"00000001-0000-4000-8000-000000000002","qty_hint":"1 cup"}]'::jsonb, '["Warm the leftover curry — add a splash of water if thick.","Serve generously over hot rice.","Top with raw onion and lemon."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000054', 'curry paratha', array['breakfast', 'lunch']::text[], 15, 2, 10, 400, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"1 tbsp"}]'::jsonb, '["Reduce the leftover curry until thick.","Knead it into atta for a spiced dough.","Roll and roast parathas with oil."]'::jsonb, array['leftover-transform', 'budget']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000055', 'curry pulao', array['lunch', 'dinner']::text[], 15, 2, 12, 470, '[{"ingredient_id":"00000001-0000-4000-8000-000000000002","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"2 tsp"}]'::jsonb, '["Heat the leftover curry in a wide pan.","Fold in cooked rice and a splash of water.","Cover and steam for five minutes, then fluff."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000056', 'egg-drop curry refresh', array['dinner']::text[], 15, 2, 16, 380, '[{"ingredient_id":"00000001-0000-4000-8000-000000000012","qty_hint":"2"}]'::jsonb, '["Bring the leftover curry to a gentle simmer.","Slip in boiled egg halves — or poach eggs straight in the gravy.","Simmer five minutes and serve with rice or roti."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000057', 'curry shorba', array['any', 'dinner']::text[], 10, 1, 8, 220, '[{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"2 tsp"}]'::jsonb, '["Thin the leftover curry with hot water and bring to a simmer.","Temper jeera in ghee and pour over.","Sip warm with black pepper on top."]'::jsonb, array['leftover-transform', 'recovery']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000058', 'paneer bhurji refresh', array['breakfast', 'dinner']::text[], 10, 2, 18, 350, '[{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1 small"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"2 tsp"}]'::jsonb, '["Crumble the leftover paneer dish into a hot oiled pan.","Add chopped onion and toss until everything dries and browns a little.","Finish with coriander and lemon."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000059', 'paneer paratha', array['breakfast', 'lunch']::text[], 15, 2, 16, 430, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"1 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"1 tbsp"}]'::jsonb, '["Mash the leftover paneer dish into a thick filling.","Stuff into atta dough rounds.","Roll gently and roast with ghee until golden."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000060', 'paneer rice bowl', array['lunch', 'dinner']::text[], 10, 1, 17, 460, '[{"ingredient_id":"00000001-0000-4000-8000-000000000002","qty_hint":"1 cup"}]'::jsonb, '["Warm the leftover paneer dish with a splash of water.","Spoon over hot rice.","Top with raw onion rings."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000061', 'paneer kathi roll', array['lunch', 'dinner']::text[], 15, 2, 19, 440, '[{"ingredient_id":"00000001-0000-4000-8000-000000000001","qty_hint":"for 2 rotis"},{"ingredient_id":"00000001-0000-4000-8000-000000000004","qty_hint":"1 small"},{"ingredient_id":"00000001-0000-4000-8000-000000000006","qty_hint":"2 tsp"}]'::jsonb, '["Dry out the leftover paneer dish in a hot pan.","Make fresh rotis or warm yesterday’s.","Roll the paneer inside with onion and a squeeze of lemon.","Pan-press the roll for a minute."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;
insert into public.dishes (id, name, slot_tags, prep_minutes, effort_score, protein_g, calories, ingredients, method_steps, tags)
values ('00000002-0000-4000-8000-000000000062', 'creamy paneer refresh', array['dinner']::text[], 12, 2, 18, 420, '[{"ingredient_id":"00000001-0000-4000-8000-000000000010","qty_hint":"0.5 cup"},{"ingredient_id":"00000001-0000-4000-8000-000000000005","qty_hint":"2 tsp"}]'::jsonb, '["Warm the leftover paneer dish in ghee.","Stir in milk and simmer until the gravy turns silky.","Serve with roti or rice."]'::jsonb, array['leftover-transform']::text[])
on conflict (id) do nothing;

-- ---------- leftover_transformations ----------
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000001', 'dal', '00000002-0000-4000-8000-000000000037', array['00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000002', 'dal', '00000002-0000-4000-8000-000000000034', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000003', 'dal', '00000002-0000-4000-8000-000000000035', array['00000001-0000-4000-8000-000000000002', '00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000004', 'dal', '00000002-0000-4000-8000-000000000036', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000005', 'dal', '00000002-0000-4000-8000-000000000038', array['00000001-0000-4000-8000-000000000002', '00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000006', 'sabzi', '00000002-0000-4000-8000-000000000043', array['00000001-0000-4000-8000-000000000004']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000007', 'sabzi', '00000002-0000-4000-8000-000000000039', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000008', 'sabzi', '00000002-0000-4000-8000-000000000040', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000004', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000009', 'sabzi', '00000002-0000-4000-8000-000000000041', array['00000001-0000-4000-8000-000000000002', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000010', 'sabzi', '00000002-0000-4000-8000-000000000042', array['00000001-0000-4000-8000-000000000012', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000011', 'rice', '00000002-0000-4000-8000-000000000044', array['00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
...
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000013', 'rice', '00000002-0000-4000-8000-000000000045', array['00000001-0000-4000-8000-000000000012', '00000001-0000-4000-8000-000000000004', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000014', 'rice', '00000002-0000-4000-8000-000000000047', array['00000001-0000-4000-8000-000000000003', '00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000015', 'rice', '00000002-0000-4000-8000-000000000046', array['00000001-0000-4000-8000-000000000010', '00000001-0000-4000-8000-000000000008']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000016', 'roti', '00000002-0000-4000-8000-000000000051', array['00000001-0000-4000-8000-000000000010']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000017', 'roti', '00000002-0000-4000-8000-000000000048', array['00000001-0000-4000-8000-000000000005', '00000001-0000-4000-8000-000000000008']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000018', 'roti', '00000002-0000-4000-8000-000000000049', array['00000001-0000-4000-8000-000000000012', '00000001-0000-4000-8000-000000000004', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000019', 'roti', '00000002-0000-4000-8000-000000000050', array['00000001-0000-4000-8000-000000000004', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000020', 'roti', '00000002-0000-4000-8000-000000000052', array['00000001-0000-4000-8000-000000000003', '00000001-0000-4000-8000-000000000004']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000021', 'curry', '00000002-0000-4000-8000-000000000053', array['00000001-0000-4000-8000-000000000002']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000022', 'curry', '00000002-0000-4000-8000-000000000054', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000023', 'curry', '00000002-0000-4000-8000-000000000055', array['00000001-0000-4000-8000-000000000002', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000024', 'curry', '00000002-0000-4000-8000-000000000056', array['00000001-0000-4000-8000-000000000012']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000025', 'curry', '00000002-0000-4000-8000-000000000057', array['00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000026', 'paneer', '00000002-0000-4000-8000-000000000060', array['00000001-0000-4000-8000-000000000002']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000027', 'paneer', '00000002-0000-4000-8000-000000000058', array['00000001-0000-4000-8000-000000000004', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000028', 'paneer', '00000002-0000-4000-8000-000000000059', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000029', 'paneer', '00000002-0000-4000-8000-000000000061', array['00000001-0000-4000-8000-000000000001', '00000001-0000-4000-8000-000000000004', '00000001-0000-4000-8000-000000000006']::text[], true)
on conflict (id) do nothing;
insert into public.leftover_transformations (id, base_category, dish_id, extra_staples, active)
values ('00000003-0000-4000-8000-000000000030', 'paneer', '00000002-0000-4000-8000-000000000062', array['00000001-0000-4000-8000-000000000010', '00000001-0000-4000-8000-000000000005']::text[], true)
on conflict (id) do nothing;
